...
customCommands.project = {
  about: "project<br>&nbsp;&nbsp;show our project QR Code, pull for scan :)",
  exe: (args) => {
    if (args.length !== 1) {
      return `project command no need other options!`
    }
    return `<img src="https://raw.githubusercontent.com/zrmin/BlogImages/master/images/202204131246834.png" style="width:200px;height:200px;margin-left:5px; border-radius: 5%"/>`
  },
}
